...
The variability of forcings and associated hydrological processes, make Mediterranean basins of special interest as observatories of climate change. Climate projections present interesting estimations of climate change. Differents techniques has been developed to correct systematic biases analysed on those projections. The widely use Quantile Mapping technique has been reported to succed removing biases from simulated time series. However, the high seasonal variability os climatological variables such as precipitation, cannot be adequately reproduced by the application of this technique based on stationary assumption. It is propose the application of a non-stationary Quantile Mapping technique to adequately correct precipitation occurrence according to the season of the year
}
